import{r as V,e as i,c as D,t as L,n as P,f as q,o as E}from"./vue.esm-bundler-_KtclwrL.js";import{_ as F}from"./_plugin-vue_export-helper-x3n3nnut.js";const x={name:"ButtonNds",props:{label:{type:String,required:!0},primary:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},type:{type:String,default:!1},size:{type:String,validator:function(e){return["small","medium","large"].indexOf(e)!==-1}},backgroundColor:{type:String}},emits:["click"],setup(e,{emit:a}){return e=V(e),{classes:i(()=>({"btn-nds":!0,"btn-nds--primary":e.primary,"btn-nds--secondary":e.secondary,"btn-nds--disabled":e.disabled,[`btn-nds--${e.size||"medium"}`]:!0})),style:i(()=>({backgroundColor:e.backgroundColor})),onClick(){a("click")}}}},O=["type"];function h(e,a,c,r,I,M){return E(),D("button",{type:c.type,class:P(r.classes),onClick:a[0]||(a[0]=(...N)=>r.onClick&&r.onClick(...N)),style:q(r.style)},L(c.label),15,O)}const w=F(x,[["render",h]]);x.__docgenInfo={displayName:"ButtonNds",exportName:"default",description:"",tags:{},props:[{name:"label",type:{name:"string"},required:!0},{name:"primary",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"disabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"type",type:{name:"string"},defaultValue:{func:!1,value:"false"}},{name:"size",type:{name:"string"},values:["small","medium","large"]},{name:"backgroundColor",type:{name:"string"}}],events:[{name:"click"}],sourceFiles:["D:/Catatanprogammer/Frontend-developer/Learning Path/Storybook/Storybook for platform/tailwind/nds-base-ui-lib/src/components/VueBased/ButtonNds/index.vue"]};const A={title:"Vue Based/Component/Button",component:w,tags:["autodocs"],argTypes:{backgroundColor:{control:"color"},onClick:{},size:{control:{type:"select"},options:["small","medium","large"]}},parameters:{order:2}},t={args:{primary:!0,label:"Button"}},s={args:{secondary:!0,label:"Button"}},n={args:{disabled:!0,label:"Button"}},o={args:{size:"large",label:"Button"}},l={args:{size:"small",label:"Button"}};var d,u,m;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    primary: true,
    label: 'Button'
  }
